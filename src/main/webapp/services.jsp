							...
							<div class="card">
								<div class="card-header">
									...
									<div class="card-tools">
										<a href="<c:url value='/services/createService' />"
										...
										<tbody>
											<c:forEach var="service" items="${services}">
												<tr>
													...
													<td><a
														href="<c:url value='/service?id=${service.id}' />"
														class="btn btn-info btn-sm"> <i class="fas fa-eye"></i>
															Details
													</a> <a href="<c:url value='/services/edit/${service.id}' />"
														class="btn btn-warning btn-sm"> <i class="fas fa-edit"></i>
															Edit
													</a> <a href="<c:url value='/services/delete/${service.id}' />"
