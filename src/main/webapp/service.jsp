...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
					...
					<div class="row">
						<div class="col-md-6 offset-md-3">
							...
							<div class="card card-primary">
								...
								<div class="card-body">
									<strong><i class="fas fa-signature mr-1"></i> Service
										name</strong>
									<p class="text-muted">
									...
									<strong><i class="fas fa-signature mr-1"></i>
										Service date</strong>
									<p class="text-muted">
										<c:out value="${service.serviceDate}" />
									</p>
							...
							<div class="text-center">
								<a href="services" class="btn btn-secondary"> <i
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-inline">Service Details
				Page</div>
