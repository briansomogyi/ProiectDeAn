							...
							<div class="card">
								<div class="card-header">
									...
									<div class="card-tools">
										<a href="<c:url value='/teams/createTeam' />"
										...
										<tbody>
											<c:forEach var="team" items="${teams}">
												<tr>
													...
													<td><a href="<c:url value='/team?id=${team.id}' />"
														class="btn btn-info btn-sm"> <i class="fas fa-eye"></i>
															Details
													</a> <a href="<c:url value='/teams/edit/${team.id}' />"
														class="btn btn-warning btn-sm"> <i class="fas fa-edit"></i>
															Edit
													</a> <a href="<c:url value='/teams/delete/${team.id}' />"
