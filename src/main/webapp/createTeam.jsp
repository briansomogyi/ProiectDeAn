...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
						...
						<div class="col-md-8 offset-md-2">
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">New Team Details</h3>
								</div>
								<form:form method="post"
									action="${pageContext.request.contextPath}/teams/saveNewTeam"
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-inline">Team Create Page</div>
